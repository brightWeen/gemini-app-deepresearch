...
const ResearcherIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
const ReviewerIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
...
export const AgentIcon: React.FC<IconProps> = ({ role, className = 'w-6 h-6' }) => {
  switch (role) {
    case AgentRole.Planner:
      return <PlannerIcon className={className} />;
    case AgentRole.Researcher:
      return <ResearcherIcon className={className} />;
    case AgentRole.Writer:
      return <WriterIcon className={className} />;
    case AgentRole.Reviewer:
        return <ReviewerIcon className={className}/>;
    default:
      return null;
  }
};
